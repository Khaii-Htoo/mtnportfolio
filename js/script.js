...
document.addEventListener('DOMContentLoaded', () => {
    // For the Name
    new TypeWriter('typewriter-name', ['I am Mya Thwe Nyein', 'I am a UI/UX Designer', 'I am a Creative Mind']);
...
document.addEventListener('mousemove', (e) => {
    ...
    // Random color
    particle.style.background = `radial-gradient(circle, ${colors[Math.floor(Math.random() * colors.length)]} 0%, transparent 100%)`;
...
const testimonials = [
    {
        quote: "Alex's UI/UX design truly transformed our app! The new interface is intuitive, beautiful, and user engagement has skyrocketed. A real star designer!",
        author: "Sarah Chen",
        title: "CEO, TechInnovate",
        avatar: "images/avatar1.jpg"
    },
    {
        quote: "Working with Alex was a fantastic experience. They understood our vision perfectly and delivered a sleek, modern design that exceeded all expectations. Highly recommend!",
        author: "Mark Davis",
        title: "Product Manager, FutureCorp",
        avatar: "images/avatar2.jpg"
    },
    {
        quote: "Beyond impressed with the user flow and visual appeal Alex brought to our platform. It's clear they have a deep understanding of user-centered design.",
        author: "Emily White",
        title: "Founder, CreativeSolutions",
        avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29329?auto=format&fit=crop&q=80&w=1780&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
    }
];
...
function renderNewTestimonial(index) {
    ...
    requestAnimationFrame(() => {
        testimonialCarousel.querySelector('.testimonial-card').classList.add('active');
    });
}
...
const projectCardWrappers = document.querySelectorAll('.project-card-3d-wrapper'); // Select all wrappers
...
projectCardWrappers.forEach(wrapper => {
    wrapper.addEventListener('click', () => {
        ...
        if (imageUrl) {
            ...
            // Add animation class directly to the image inside modal
